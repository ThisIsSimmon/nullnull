...
<body <?php body_class(); ?> data-barba="wrapper">
    ...
    <main id="main" data-barba="container" data-barba-namespace="home">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" hidden>
            ...
            <symbol width="22" height="26" fill="none" id="logo">
                <g filter="url(#filter0_di)">
                    <path d="M17.15 1.225c.48 0 .87.16 1.17.48.3.32.45.72.45 1.2v17.49c0 .52-.18.96-.54 1.32-.34.34-.77.51-1.29.51-.28 0-.56-.04-.84-.12-.26-.1-.45-.23-.57-.39L4.52 7.735v12.81c0 .48-.16.88-.48 1.2-.3.32-.7.48-1.2.48-.48 0-.87-.16-1.17-.48-.3-.32-.45-.72-.45-1.2V3.055c0-.52.17-.95.51-1.29.36-.36.8-.54 1.32-.54.3 0 .59.06.87.18.3.12.52.28.66.48l10.92 13.92v-12.9c0-.48.15-.88.45-1.2.32-.32.72-.48 1.2-.48z" fill="#fff" />
                </g>
                <defs>
                    <filter id="filter0_di" x=".22" y=".225" width="21.55" height="25" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
